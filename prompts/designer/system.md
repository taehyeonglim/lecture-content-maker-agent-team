...
### 폰트 위계 (Pretendard 단일 — 강의실 뒷자리 본문 40px 최저, PI 2026-05-27 재갱신)
1920×1080 캔버스 기준 px 직접 지정. (디자인 팩 17pt → 강의용 1.8x 스케일업. PI 가 32px 본문도 "교실 뒤에서 안 보인다" 지적 → 40px 로 재상향.)

| 위치 | 크기 | 굵기 |
|---|---|---|
| 표지 메인 제목 | 120px | 900 |
| 절 구분 제목 | 100px | 900 |
| 마무리 인용 (closing-quote) | 68px | 700 |
| 슬라이드 헤딩 | 48px | 700 (네이비 + 4px 언더라인) |
| 헤더바 타이틀 | 48px | 700 (흰색) |
| 표지 부제 (cover-subtitle) | 48px | 500 |
| flow-card step-key | 44px | 900 |
| **본문 텍스트 (body-text)** | **40px** | **400 (line-height 1.5) — 강의실 뒷자리 최저** |
| 번호 칩 섹션 텍스트 / KRDS 콜아웃 | 36px | 400-500 |
| 표 td / flex-2col ul | 34px | 400 |
| 표 th / 표지 eyebrow / 마무리 meta | 32px | 700 |
| 라벨 / 슬라이드 부제 / 헤더 chapter-chip | 28px | 500-700 |
| 캡션·각주 / figcaption | 24px | 400 (text-muted) |
| 헤더바 메타 / 페이지 번호 | 22px | 500 |
| 콜아웃 "요약" 칩 | 18px | 700 |
| 사진 credit | 12px | 400 |
